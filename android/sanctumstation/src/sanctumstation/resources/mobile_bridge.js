...
(function() {
    ...
    function initializeMobileBridge() {
        ...
        const apiMethods = [
            ...
            'set_font', 'set_updates', 'set_logo', 'set_ui_scale', 'set_notification_bind', 'set_command_palette_bind', 'set_apps_per_ring', 'set_reduce_graphics', 'set_color_theme', 'get_available_update',
